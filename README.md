...
This repository contains processing code to analyze the molecular dynamics trajectories analyzed in the paper "LNPDB: structure-function database of lipid nanoparticles to advance data-driven design for nucleic acid delivery" (under review).
